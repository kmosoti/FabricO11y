...
| ADR-0002 | Separate observation, correction, frontier, and answer envelopes | Planned | FO01 |
| ADR-0003 | Put domain semantics in a pure Rust core | Planned | FO02 |
| ADR-0004 | Make the embedded SDK primary and the daemon optional | Planned | FO05 |
| ADR-0005 | Use immutable Zstd-compressed segments plus a SQLite catalog | Planned | FO03 |
| ADR-0006 | Treat maintained indexes as the primary search path | Planned | FO08 |
| ADR-0007 | Model multiple time axes and explicit causal edges | Planned | FO01 |
